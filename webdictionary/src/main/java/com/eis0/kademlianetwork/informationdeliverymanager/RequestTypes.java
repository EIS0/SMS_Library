...
/**
 * This enum contains the ResourceRequest Types, which are the CODE placed at the beginning of every message
 * sent through the network; they identify the ResourceRequest contained in each message, depending upon
